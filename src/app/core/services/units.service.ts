...
// lat/lon
  ...
  /**
   * Returns array of Signal K base units (units supported by SK). Use
   * this method to obtain the list of possible units that can be PUT to
   * Signal K path's meta.units property.
   *
   * NOTE1: This list is based on Signal K schema v1.7
   * NOTE2: THis list is for SK server operation. See getDefaults() and getConversions()
   * for KIP value conversions.
   *
